...
[main/java/com/ohnosequences/util/model/PalindromicityResult.java]: PalindromicityResult.java.md
[main/java/com/ohnosequences/util/model/Intergenic.java]: Intergenic.java.md
[main/java/com/ohnosequences/util/model/Feature.java]: Feature.java.md
